...
#define RTL8201_BCR ((uint16_t)00U)
#define RTL8201_BCR_SOFT_RST      ((uint16_t)0x8000U)
...
#define RTL8201_ISOLATE           ((uint16_t)0x0400U)
#define RTL8201_BCR_AUTONEGO_RST  ((uint16_t)0x0200U)
#define RTL8201_BCR_DUPLEX_MODE   ((uint16_t)0x0100U)

#define RTL8201_BSR ((uint16_t)01U)
...
#define RTL8201_ANAR_ACK                  ((uint16_t)0x4000U)
...
#define RTL8201_ANAR_100BASE_T4           ((uint16_t)0x0200U)
...
#define RTL8201_ANLPAR ((uint16_t)05U)
...
#define RTL8201_ANLPAR_100BASE_T4           ((uint16_t)0x0200U)
...
#define RTL8201_ANER ((uint16_t)06U)
...
#define RTL8201_MMDACR  ((uint16_t)13U)
...
#define RTL8201_MMDAADR ((uint16_t)14U)

/* Power Saving Mode Register */
#define RTL8201_PSM  ((uint16_t)24U)
#define RTL8201_PSM_MASK     ((uint16_t)0x8000U)
#define RTL8201_PSM_SET_PSM ((uint16_t)0x8000U)

/* Page Setting Register */
#define RTL8201_PSR ((uint16_t)31U)
#define RTL8201_PSR_MASK ((uint16_t)0x00FFU)
#define RTL8201_PSR_P0   ((uint16_t)0x0000U)
#define RTL8201_PSR_P7   ((uint16_t)0x0007U)


/* RMII Mode Setting Register */
#define RTL8201_P7_RMSR ((uint16_t)16U)
#define RTL8201_P7_RMSR_RMII_MODE_MASK ((uint16_t)0x0008U)
#define RTL8201_P7_RMSR_TX_TIMING_MASK ((uint16_t)0x0F00U)
#define RTL8201_P7_RMSR_RX_TIMING_MASK ((uint16_t)0x00F0U)
#define RTL8201_P7_RMSR_SET_RMII_MODE  ((uint16_t)0x0008U)
#define RTL8201_P7_RMSR_TX_TIMING      ((uint16_t)0x0500U)
#define RTL8201_P7_RMSR_RX_TIMING      ((uint16_t)0x0040U)
